...
class BookshelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookshelf" do
    assert_difference('Bookshelf.count') do
      post bookshelves_url, params: { bookshelf: { book_id: @bookshelf.book_id, number: @bookshelf.number, user_id: @bookshelf.user_id } }
    end
  ...
  test "should update bookshelf" do
    patch bookshelf_url(@bookshelf), params: { bookshelf: { book_id: @bookshelf.book_id, number: @bookshelf.number, user_id: @bookshelf.user_id } }
